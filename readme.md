...
Опционально (выполняется по желанию):

Предложите свой вариант организации кода для этого мини-проекта (структура папок, классов, методов и т.д.). Можно организовать код в любом формате на ваше усмотрение, но без использования внешних фреймворков.